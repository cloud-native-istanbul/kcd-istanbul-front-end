          ...
          <div className="container has-text-centered">
            ...
            <div className="box mt-5" style={{ backgroundColor: 'rgba(255,255,255,0.95)' }}>
              <p className="is-size-4 has-text-dark">
                <strong className="has-text-dark">Date:</strong> July 10-11, 2026 | <strong className="has-text-dark">Location:</strong> Istanbul Bilgi University, Santralistanbul Campus
              </p>
            </div>
